...
"[project]/app/api/expenses/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    ...
    try {
        ...
        if (!userId || !date || !title || !amount) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'userId, date, title and amount are required'
            }, {
                status: 400
            });
        }
        ...
        const expense = {
            id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["nextId"])('exp'),
            userId,
            date,
            title,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__03sg1qs._.js.map