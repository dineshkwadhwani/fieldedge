...
"[project]/app/api/attendance/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    if (forSpan) {
        const spanUsers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSpan"])(forSpan).map((u)=>u.id);
...
async function POST(request) {
    ...
    try {
        ...
        if (type === 'present' && !locationId) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Location is required when marking present'
            }, {
                status: 400
            });
        }
        ...
        const record = {
            id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["nextId"])('att'),
            userId,
            date,
            type,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0r2bhgo._.js.map